...
public class FixedDelayTimerBeanTest {
    ...
    public static WebArchive deploy() {
        ...
        return ShrinkWrap.create(WebArchive.class)
                .addAsLibraries(jars)
                .addClasses(WithinWindowMatcher.class, TimerEvent.class, TimerEventListener.class, FixedDelayTimerBean.class, WorkerBean.class);
    }
    ...
    public void should_receive_two_pings() {
        Awaitility.setDefaultTimeout(3600, TimeUnit.SECONDS);
        //the test will wait here until two events are triggered
        await().untilCall(to(timerEventListener.getEvents()).size(), equalTo(2000));
